...
WhiteSpace = [ \t\r\n\f]
ID = [a-zA-Z_][a-zA-Z0-9_]* // New rule for identifiers
...
"="               { return symbol(sym.EQ); } // Assuming EQ for assignment, will be added to sym.java

/* Identificadores */
{ID}              { return symbol(sym.ID, yytext()); } // Rule to recognize identifiers
